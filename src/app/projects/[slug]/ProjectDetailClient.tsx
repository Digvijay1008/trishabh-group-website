...
const projectsData = {
  "trishabh-park-view": {
    ...
    towerColor: "#8C7B6B",
    highlight: "#C8A870",
    vision: "Designed for the modern connoisseur, Park View is an architectural triumph standing tall in the heart of Chembur. It seamlessly blends biophilic design principles with unparalleled luxury, ensuring every residence receives an abundance of natural light and cross-ventilation.",
  ...
  "trishabh-serenity": {
    ...
    towerColor: "#7A6B5B",
    highlight: "#B89860",
    vision: "Serenity represents the pinnacle of elevated living. Overlooking the tranquil Powai lake, these sky residences feature expansive decks and floor-to-ceiling glass facades, erasing the boundary between the opulent interiors and nature outside.",
    amenities: ["Lake View Decks", "Private Elevator Access", "Clubhouse", "Tennis Court", "Spa & Wellness Center", "Concierge"],
  }
};
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="relative h-[80vh] min-h-[600px] w-full flex items-end pb-24" style={{ background: project.bgBase || "#EDE9E2" }}>
        ...
        <div className="container-luxury relative z-10 w-full">
          <Link href="/projects" className="inline-flex items-center gap-2 text-[#161616]/60 hover:text-[#161616] mb-12 transition-colors" style={{ fontFamily: "var(--font-inter)", fontSize: "0.6875rem", letterSpacing: "0.1em", textTransform: "uppercase" }}>
            <ArrowLeft size={12} />
            Back to Portfolio
          </Link>
          ...
          >
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/20 backdrop-blur-md text-white mb-6" style={{ fontFamily: "var(--font-inter)", fontSize: "0.5625rem", letterSpacing: "0.12em", textTransform: "uppercase", fontWeight: 500 }}>
              {project.status}
            </div>
            
            <h1 className="text-white mb-4" style={{ fontFamily: "var(--font-cormorant)", fontSize: "clamp(3.5rem, 6vw, 6rem)", fontWeight: 400, lineHeight: 1 }}>
              {project.title || project.name}
            </h1>
            
            <div className="flex items-center gap-6 text-white/70" style={{ fontFamily: "var(--font-inter)", fontSize: "0.9375rem" }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            >
              <div className="flex items-center gap-4 mb-8">
                ...
                <span className="text-[#3F3F46]/50" style={{ fontFamily: "var(--font-inter)", fontSize: "0.625rem", letterSpacing: "0.2em", textTransform: "uppercase" }}>
                  The Vision
                </span>
              </div>
              <h2 className="text-[#161616] mb-8" style={{ fontFamily: "var(--font-cormorant)", fontSize: "2.5rem", lineHeight: 1.2 }}>
                  ...
                  <div className="grid grid-cols-2 gap-y-4 gap-x-8">
                    {project.amenities.map((amenity: string) => (
                      <div key={amenity} className="flex items-center gap-3">
                        ...
                        <span className="text-[#3F3F46]" style={{ fontFamily: "var(--font-inter)", fontSize: "0.875rem" }}>{amenity}</span>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            >
              <div className="bg-[#FAF9F7] border border-[#E7E2D9] p-10 sticky top-32">
                <h3 className="text-[#161616] mb-8 pb-6 border-b border-[#E7E2D9]" style={{ fontFamily: "var(--font-cormorant)", fontSize: "1.75rem" }}>
                  Project Details
                </h3>
                ...
                <div className="space-y-6 mb-10">
                  {[
                    ...
                    <div key={stat.label}>
                      <div className="text-[#3F3F46]/40 mb-1" style={{ fontFamily: "var(--font-inter)", fontSize: "0.625rem", letterSpacing: "0.1em", textTransform: "uppercase" }}>
                        {stat.label}
                      </div>
                      <div className="text-[#161616]" style={{ fontFamily: "var(--font-inter)", fontSize: "1rem", fontWeight: 500 }}>
                        {stat.value}
                      </div>
                    </div>
                  ))}
                ...
                <div className="space-y-4">
                  <Link
                    ...
                    style={{ fontFamily: "var(--font-inter)", fontSize: "0.6875rem", letterSpacing: "0.15em", textTransform: "uppercase", fontWeight: 500 }}
                  >
                    Request Viewing
